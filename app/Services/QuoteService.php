...
class QuoteService
{
     ...
     */
    public function getQuoteWithParams(array $params = []): array
    {
        try {
            $queryParams = [];
            ...
            if (!empty($params['maxLength'])) {
                $queryParams['maxLength'] = $params['maxLength'];
            }
            
            if (!empty($params['minLength'])) {
                $queryParams['minLength'] = $params['minLength'];
            }
            
            $response = Http::timeout(10)->get(self::API_URL, $queryParams);
